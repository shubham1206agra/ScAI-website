...
const NotFound = () => {
    return (
        <React.Fragment>
            <main className={styles.bbody}>
                <div className={styles.container}>
                    <div className={styles.row}>
                        <div
                            className={`${styles.colmd6} ${styles.alignselfcenter}`}
                        >
                            <Tween to={{ visibility: "visible" }} duration={0}>
                                <svg
				...
				s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z"
					...
					278.436,375.599 383.003,264.076 364.393,251.618 264.807,364.928 				"
                        ...
                        <div
                            className={`${styles.colmd6} ${styles.alignselfcenter}`}
                        >
                            <h1 className={styles.ch1}>404</h1>
                            <h2 className={styles.ch2}>UH OH! You're lost.</h2>
                            <p>
                            ...
                            <Link href="/">
                                <button
                                    className={`${styles.btnx} ${styles.green}`}
                                >
                                    HOME
                                </button>
                            </Link>
